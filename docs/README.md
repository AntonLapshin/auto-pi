...
- `commands.md` — `/loop-seed`, `/loop-stop`, `/loop-status`, `/loop-logs`, `/loop-resume`, `/loop-sync-config`, `/loop-doctor`, `/loop`
...
- `pilot-report.md` — the M12 end-to-end pilot report and M13 hardening notes

...
| 1 | Environment Doctor | 0 | `/doctor`: validate git/gh/node/npm/pi/token prerequisites |
| 2 | `/seed` Initiation | 0, 1 | Clarification, repo naming, repo creation, workspace, one-project-per-machine |
...
| 12 | Pilot Project | 0–11 | End-to-end `/seed` pilot with full lifecycle validation |

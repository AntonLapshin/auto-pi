...
**Reference:** original build plan (§24, §28 "Milestone 11"; historical — canonical docs: README.md, docs/architecture.md, docs/commands.md)
...
- [x] Config-driven and env-driven (original plan §24):
...
- [x] Send messages for events:
  - project completed (original plan §24 completion message: project, repo, demo URLs)

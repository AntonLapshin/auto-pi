...
Milestones 0–5 are in place: the harness skeleton, the `/doctor` environment
...
`.pi/config.json` + the git-ignored local-secrets scaffold (M5) are implemented.
The remaining loop commands report "not implemented"
